...
const QuoteSection = () => {
  ...
  <div className="max-w-lg text-center">
    ...
    <div className="flex  items-center mb-6">
      {/* Quote Icon */}
      <FaQuoteLeft className="text-gray-700 text-5xl mb-14" />
  ...
  <div className="w-16 h-16 rounded-full border-2 border-gray-300 flex justify-center items-center">
  ...
  {/* Our History Heading */}
  <h2 className="text-xs font-bold text-gray-950 text-center lg:text-left mb-8 lg:ml-[380px] 2xl:ml-[900px]">
    Our History
  </h2>

  {/* Flex Container for Main Description and Key Initiatives */}
  <div className="flex flex-col lg:flex-row gap-8 lg:ml-[380px] 2xl:ml-[900px]">
    {/* Main Description */}
