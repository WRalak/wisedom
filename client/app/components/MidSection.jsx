    ...
    <div>
      ...
      <section className="w-full py-20 overflow-x-hidden">
        <div className="container mx-auto px-4 lg:px-16 xl:px-32 ">
          <div className="overflow-hidden lg:ml-[250px] 2xl:ml-[400px]">
            <div
            ...
            >
              {years.map((year, index) => (
                <div
                  key={index}
                  className="min-w-[220px] sm:min-w-[280px] h-[170px] flex flex-col ml-2 bg-gray-50 p-4 rounded-md mx-2"
                >
          ...
          <div className="flex space-x-2 mt-4 justify- lg:ml-[250px] 2xl:ml-[400px]">
            {years.map((_, index) => (
              <div
                key={index}
      ...
      <section className="py-10">
        <div className="mx-auto px-4 flex justify-center lg:ml-48 xl:ml-72">
          <Image
      ...
      <section className="w-full py-20">
        <div className="container mx-auto px-4 lg:px-16 xl:px-32">
          ...
          <div className="flex flex-col items-start max-w-md mx-auto">
            {faqs.map((faq, index) => (
              <div key={index} className="mb-4 cursor-pointer w-full">
                <div onClick={() => toggleFAQ(index)} className="flex items-center">
          ...
          <p className="text-xs text-blue-500 font-semibold flex justify-center items-center gap-1 lg:justify-start lg:ml-[330px]">
            See more <MdArrowOutward size={13} />
          </p>
        </div>

        {/* Team Members */}
        <div className="mt-12 text-left md:text-center lg:text-left  px-4 md:px-8 lg:px-0 lg:ml-[390px] 2xl:ml-[980px] ">
