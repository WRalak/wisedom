...
const AboutUsSection = () => {
  return (
    <section className="relative py-10 lg:py-16 flex justify-center items-center bg-white">
      {/* Image Container */}
      <div className="relative w-full max-w-[800px] h-[276px] sm:h-[350px] lg:h-[300px] 2xl:w-[900px] 2xl:h[450px]: mt-8 lg:mt-0 lg:ml-48">
        ...
        {/* Content */}
        <div className="absolute inset-0 flex flex-col justify-center items-start text-left text-white px-4  sm:px-6 lg:px-16">
          <h1 className="text-xs sm:text-xs md:text-xs   mb-2">ABOUT US</h1>
          {/* Red Divider */}
          <div className="w-[28px] h-[2px] bg-red-500 mb-6 lg:mb-8"></div>
          <p className="text-xs sm:text-xs md:text-xs font-semibold  leading-relaxed mb-4">
          ...
          <p className="text-xs sm:text-xs md:text-xs mt-2 leading-relaxed">
